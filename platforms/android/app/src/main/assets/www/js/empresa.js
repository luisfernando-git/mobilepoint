...
function saveEmpresa() {
    ...
    var urlPost = 'http://10.1.15.19:9091/api/mobilepoint/empresas';
    if (empresa == undefined) {
        ...
        var urlPut = 'http://10.1.15.19:9091/api/mobilepoint/empresas/' + empresa.id;
...
function findEmpresa() {
    var url = 'http://10.1.15.19:9091/api/mobilepoint/empresas';
